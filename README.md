...
## Dependencies
* ABRicate v0.8.11 (https://github.com/tseemann/abricate) with all its dependecies such as Blast+ v2.2.30, Emboss etc, also  need to build a 16S rRNA database; other versions not tested
